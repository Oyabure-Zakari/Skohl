  ...
  return (
    <View style={{ borderRadius: 10, overflow: "hidden" }}>
      ...
      >
        ...
        <Picker.Item label="Agriculture" value="Agriculture" style={{ color: COLORS.darkGrey }} />

        <Picker.Item label="Arts" value="Arts" style={{ color: COLORS.darkGrey }} />
        ...
        <Picker.Item label="Education" value="Education" style={{ color: COLORS.darkGrey }} />

        <Picker.Item label="Engineering" value="Engineering" style={{ color: COLORS.darkGrey }} />
        ...
        <Picker.Item label="Pharmacy" value="Pharmacy" style={{ color: COLORS.darkGrey }} />
